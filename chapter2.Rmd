...
p2 <- ggplot(learning2014, aes(x = deep, y = Points))
p2
...
my_regression_model1 <- lm(Points ~ Attitude + deep + stra, data = learning2014)
...
my_regression_model1 <- lm(Points ~ 1, Attitude + deep + stra, data = learning2014)
my_regression_model1

summary(my_regression_model1)
```
# there's some significanse in the air
